"""
Django settings for yerftest_183 project.
...
ROOT_URLCONF = 'yerftest_183.urls'
...
WSGI_APPLICATION = 'yerftest_183.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yerftest_183 API",
    "DESCRIPTION": "API documentation for yerftest_183 App",
    "VERSION": "v1",
}
